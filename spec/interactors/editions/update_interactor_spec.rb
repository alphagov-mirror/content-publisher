...
RSpec.describe Editions::UpdateInteractor do
  describe ".call" do
    ...
    it "succeeds with default parameters" do
      result = Editions::UpdateInteractor.call(params: build_params, user: user)
    ...
    it "updates the edition" do
      ...
      expect { Editions::UpdateInteractor.call(params: params, user: user) }
        .to change { edition.reload.title }.to("New title")
        .and change { edition.reload.summary }.to("New summary")
    end

    it "creates a timeline entry" do
      expect { Editions::UpdateInteractor.call(params: build_params, user: user) }
    ...
    it "updates the preview" do
      ...
      Editions::UpdateInteractor.call(params: build_params, user: user)
    end
    ...
    it "fails if the content is unchanged" do
      ...
      result = Editions::UpdateInteractor.call(params: params, user: user)
